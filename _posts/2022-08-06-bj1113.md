...
#### 문제
[![1713.cpp](/assets/images/algorithm/baekjoon/gold/bj1113/problem.jpg)](https://www.acmicpc.net/problem/1113)
...
{
    queue<point> block;
    vector<point> cardinal_point = {% raw %}{{-1, 0}, {0, -1}, {1, 0}, {0, 1}}{% endrew %};
    int count = 1;
        bool check = false;
